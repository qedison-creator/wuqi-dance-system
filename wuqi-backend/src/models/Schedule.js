...
const scheduleSchema = new mongoose.Schema({
  ...
  status: { type: String, enum: ['not_open', 'available', 'full', 'offline', 'cancelled', 'in_progress', 'completed', 'deleted'], required: true, default: 'available' },
  cancel_reason: { type: String, enum: ['min_bookings_not_met', 'admin_cancel', 'holiday', 'admin_offline', null], default: null },
