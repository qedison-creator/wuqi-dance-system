...
const bookingSchema = new mongoose.Schema({
  ...
  status: { type: String, enum: ['booked', 'cancelled', 'completed', 'absent'], required: true, default: 'booked' },
  cancel_reason: { type: String },
  cancelled_at: { type: Date },
  is_exempt: { type: Boolean, default: false },
  remark: { type: String },
  // 扩展字段
  booking_status: { type: String, enum: ['booked', 'cancelled', 'completed'], default: 'booked' },
